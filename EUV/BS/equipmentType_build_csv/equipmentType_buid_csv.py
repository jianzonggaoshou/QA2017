...
# 系统管理
browser.find_element_by_xpath('/html/body/div/index-header/div[1]/div[2]/div/div[1]/i').click()
sleep(1)
browser.find_element_by_link_text('设备类型管理').click()
...
for userData in data:
	...
	# 新增
	sleep(2)
	browser.find_element_by_id('news').click()
	# 表单
	sleep(1)
	browser.find_element_by_id('name').clear()
	browser.find_element_by_id('name').send_keys(userData[0].decode('gb2312'))
	browser.find_element_by_xpath(
		'/html/body/div/index-header/div[3]/div[2]/div/div/form/div[2]/textarea').clear()
	browser.find_element_by_xpath(
		'/html/body/div/index-header/div[3]/div[2]/div/div/form/div[2]/textarea').send_keys(
