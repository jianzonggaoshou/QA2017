...
browser.switch_to.frame("/sito2000/action/sd/wf/contractProject/getContract?contractId=49")
...
sleep(3)
browser.switch_to.parent_frame()
browser.switch_to.frame('/sito2000//workflow/project_add.jsp?contractId=49&projectId=308&projectState=1')
