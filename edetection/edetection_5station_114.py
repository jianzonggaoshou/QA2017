...
# sleep(1)
# # 乌鲁木齐电业局
# # browser.find_element_by_xpath('//*[@id="enterpriseId"]/option[20]').click()
# # 测试运维站
# browser.find_element_by_xpath('//*[@id="enterpriseId"]/option[15]').click()
#
...
# sleep(1)
# browser.find_element_by_xpath('//*[@name="companyId"]/option[20]').click()
#
...
# 	browser.find_element_by_xpath('//*[@id="ext-gen234"]/div[1]/table/tbody/tr/td[2]/div/div').click()
# 	browser.find_element_by_xpath('//*[@id="ext-gen234"]/div[2]/table/tbody/tr/td[2]/div/div').click()
# 	browser.find_element_by_xpath('//*[@id="ext-gen234"]/div[3]/table/tbody/tr/td[2]/div/div').click()
#
# 	# 检测仪器
# 	sleep(1)
# 	browser.find_element_by_xpath('//*[@id="ext-gen255"]/div/table/tbody/tr/td[2]/div/div').click()
#
# 	# 人员列表
# 	sleep(1)
# 	browser.find_element_by_xpath('//*[@id="ext-gen275"]/div/table/thead/tr/td[2]/div/div').click()
#
# 	# ****************************************************************************
# 	# 选择台账2
# 	sleep(3)
...
# 	# sleep(1)
# 	# browser.find_element_by_xpath('//*[@id="ext-gen294"]/div/table/thead/tr/td[2]/div/div').click()
# 	browser.find_element_by_xpath('//*[@id="ext-gen320"]/div[1]/table/tbody/tr/td[2]/div/div').click()
# 	browser.find_element_by_xpath('//*[@id="ext-gen320"]/div[2]/table/tbody/tr/td[2]/div/div').click()
# 	browser.find_element_by_xpath('//*[@id="ext-gen320"]/div[3]/table/tbody/tr/td[2]/div/div').click()
#
# 	# 检测仪器
# 	sleep(1)
# 	browser.find_element_by_xpath('//*[@id="ext-gen341"]/div[1]/table/tbody/tr/td[2]/div').click()
#
# 	# 人员列表
# 	sleep(1)
# 	browser.find_element_by_xpath('//*[@id="ext-gen361"]/div/table/thead/tr/td[2]/div').click()
#
# 	# 保存
# 	sleep(1)
